...
import com.equipamento.Entity.Tranca; // Verifique se o pacote está correto
...
public interface TrancaMapper {
    ...
    @Mapping(target = "statusTranca", expression = "java(com.equipamento.Entity.StatusTranca.NOVA)") // <--- CORREÇÃO AQUI!
